...
var nav = document.querySelectorAll('.js-main-nav')[0];
var btn = document.querySelectorAll('.js-main-nav-btn')[0];
...
btn.addEventListener('click', function () {
    toogleClass(nav, 'open');
    toogleClass(this, 'active');
});

function addPropertiesToArr(arr, props) {
...
function addStylesToLine(arr, styles) {
    // arr: Object[]
    // styles: Object[]
 ...
 */
var response = [{
    name: 'Forecast', data: [[(0, _moment2.default)('2014-10-09').valueOf(), 7.0], [(0, _moment2.default)('2014-10-10').valueOf(), 6.9], [(0, _moment2.default)('2014-10-11').valueOf(), 9.5], [(0, _moment2.default)('2014-10-12').valueOf(), 14.5], [(0, _moment2.default)('2014-10-13').valueOf(), 18.2], [(0, _moment2.default)('2014-10-14').valueOf(), 21.5], [(0, _moment2.default)('2014-10-15').valueOf(), 25.2], [(0, _moment2.default)('2014-10-16').valueOf(), 26.5]]
}, {
    name: 'Occupants', data: [[(0, _moment2.default)('2014-10-09').valueOf(), 5.0], [(0, _moment2.default)('2014-10-10').valueOf(), 4.9], [(0, _moment2.default)('2014-10-11').valueOf(), 20.5], [(0, _moment2.default)('2014-10-12').valueOf(), 12.5], [(0, _moment2.default)('2014-10-13').valueOf(), 17.2], [(0, _moment2.default)('2014-10-14').valueOf(), 20.5], [(0, _moment2.default)('2014-10-15').valueOf(), 24.2]]
}];

addPropertiesToArr(response, {
    type: "area",
    marker: markerStyle
});

addStylesToLine(response, [{
    dashStyle: 'shortdash',
    color: '#cfd0d6'
}, {
    color: '#4483fa'
...
var occupancyEl = document.getElementById('time_occupancy');
if (occupancyEl) {
    Highcharts.chart('time_occupancy', {
        chart: {
            type: 'spline',
            style: {
        ...
        legend: {
            ...
            labelFormatter: function labelFormatter() {
                return '<span class="label-custom__text">' + this.name + '</span>';
            }
        },
        xAxis: {
            type: 'datetime',
            ...
            //     color: '#b0b4c7',
            //     dashStyle: 'solid',
            //     value: moment('2014-04-01').valueOf(),
            //     width: 1
            // }],
            style: {
                color: '#5e5d67'
        ...
        tooltip: {
            ...
            headerFormat: '<div class="tooltip-custom__title">{point.key}</div><table>',
            pointFormat: '<tr><td style="color: {series.color}">' + '<span class="tooltip-custom__marker" style="background: {series.color}"></span> ' + '<span class="tooltip-custom__name">{series.name}:</span> </td>' + '<td style="text-align: right"><b>{point.y}</b></td></tr>',
            footerFormat: '</table>'
        },
        credits: {
            enabled: false
...
var employerChart = document.getElementById('electicity-use');
if (employerChart) {
    Highcharts.chart('electicity-use', {
        chart: {
            type: 'spline',
            style: {
                fontFamily: '\'Open Sans\', sans-serif'
...
addStylesToLine(response2, [{
    color: '#4483fa'
}]);

var patternsEl = document.getElementById('patterns');
if (patternsEl) {
    Highcharts.chart('patterns', {
        chart: {
            type: 'areaspline',
            style: {
                fontFamily: '\'Open Sans\', sans-serif'
...
var patterns2El = document.getElementById('patterns2');
if (patterns2El) {
    Highcharts.chart('patterns2', {
        chart: {
            type: 'areaspline',
            style: {
                fontFamily: '\'Open Sans\', sans-serif'
...
var patterns3El = document.getElementById('patterns3');
if (patterns3El) {
    Highcharts.chart('patterns3', {
        chart: {
            type: 'areaspline',
            style: {
                fontFamily: '\'Open Sans\', sans-serif'
...
var pieColors = [{ color: '#7ac665' }, { color: '#4886ff' }, { color: '#8a6df7' }, { color: '#f63372' }, { color: '#ffa124' }];
var pieData = [{
    name: 'Spain',
    y: 505370
}, {
...
addStylesToLine(pieData, pieColors);
addStylesToLine(pieData2, pieColors);
            ...
            variablepie: {
                ...
                dataLabels: {
                    ...
                    formatter: function formatter() {
                        return '<span class="pie-label-custom">' + Math.round(this.percentage) + '%' + '</span>';
                    },
                    distance: -19,
                    color: 'white'
                }
...
var pie2El = document.getElementById('pie2');
if (pie2El) {
